...
public class Prospector : MonoBehaviour
{
        ...
        switch (cd.state)
        {
            ...
            case eCardState.tableau:
                ...
                if (!validMatch) return; // return if not valid
                                         // If we got here Yay! It's a valid card.
    ...
    //Returns true if the two cards are adjacent in rank (A & K wrap around)
        ...
        switch (evt)
        {
            ...
            case eScoreEvent.gameLoss: //Lost the round
                ...
                if (fsRun != null)
                {
                    ...
                    // The fsPosMid is the middle of the table between the
                    // drawPile and the target
                    fsPts.Add(fsPosMid2);
                    // Add the second point in the curve
                    fsPts.Add(fsPosEnd);
                    // Setting fsRun to true will start it moving
